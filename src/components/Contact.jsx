    ...
    <div id = "contact" className="p-[2rem] lg:p-[6rem] bg-background relative">
      ...
      <div className="justify-between lg:flex" data-aos="flip-up">
        <form onSubmit={sendEmail} ref={form}>
          <label className="block mb-1 text-sm text-white" htmlFor="name">
            Name
          </label>
          <input
            type="text"
          ...
          <br />
          <br />
          <label className="block mb-1 text-sm text-white" htmlFor="message">
            Message
          </label>
          <textarea
            name="message"
      ...
      <div
        className="flex flex-col gap-4 absolute lg:left-6 left-1 bottom-[50%] cursor-pointer "
        data-aos="flip-up"
      >
        <a
          href="https://github.com/Highshirt99"
          className="text-white text-[20px] hover:text-body"
        >
